...
module.exports.init = (io) => {
  ...
  // TODO refactor to use lodash _.every
  ...
  const emitUpdate = (room) => {
    ...
    // Log current data
    debug('-_-_-_-_-_-_-_-'); // eslint-disable-line no-console
    debug(prettyJson.render(data, { // eslint-disable-line no-console
      keysColor: 'blue',
      stringColor: 'red',
    }));
  };
  ...
  // TODO: make map of <socketId, room> to bring down complexity to O(1)
  const getRoom = (id) => {
    let originRoom;
